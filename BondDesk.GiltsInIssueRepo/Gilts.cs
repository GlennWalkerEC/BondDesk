...
public class Gilts : IGiltRepo
{
    public IEnumerable<IGiltInfo> GetAllGilts()
    {
        ...
        yield return new GiltInfo("T26", "0 1/8% Treasury Gilt 2026", 0.13m, new DateTime(2026, 1, 30));
        yield return new GiltInfo("TG26", "1½% Treasury Gilt 2026", 1.50m, new DateTime(2026, 7, 22));
        yield return new GiltInfo("T26A", "0 3/8% Treasury Gilt 2026", 0.38m, new DateTime(2026, 10, 22));
        yield return new GiltInfo("T27A", "4 1/8% Treasury Gilt 2027", 4.13m, new DateTime(2027, 1, 29));
        ...
        yield return new GiltInfo("TN28", "0 1/8% Treasury Gilt 2028", 0.13m, new DateTime(2028, 1, 31));
        yield return new GiltInfo("TE28", "4 3/8% Treasury Gilt 2028", 4.38m, new DateTime(2028, 3, 7));
        yield return new GiltInfo("TS28", "4½% Treasury Gilt 2028", 4.50m, new DateTime(2028, 6, 7));
        yield return new GiltInfo("TG28", "1 5/8% Treasury Gilt 2028", 1.63m, new DateTime(2028, 10, 22));
        ...
        yield return new GiltInfo("TR29", "0 7/8% Treasury Gilt 2029", 0.88m, new DateTime(2029, 10, 22));
        yield return new GiltInfo("T30", "4 3/8% Treasury Gilt 2030", 4.38m, new DateTime(2030, 3, 7));
        yield return new GiltInfo("TG30", "0 3/8% Treasury Gilt 2030", 0.38m, new DateTime(2030, 10, 22));
        ...
        yield return new GiltInfo("TG33", "0 7/8% Green Gilt 2033", 0.88m, new DateTime(2033, 7, 31));
        yield return new GiltInfo("T34", "4 5/8% Treasury Gilt 2034", 4.63m, new DateTime(2034, 1, 31));
        ...
        yield return new GiltInfo("TG35", "0 5/8% Treasury Gilt 2035", 0.63m, new DateTime(2035, 7, 31));
        ...
        yield return new GiltInfo("TR39", "1 1/8% Treasury Gilt 2039", 1.13m, new DateTime(2039, 1, 31));
        yield return new GiltInfo("T39", "4¼% Treasury Gilt 2039", 4.25m, new DateTime(2039, 9, 7));
        yield return new GiltInfo("TG40", "4 3/8% Treasury Gilt 2040", 4.38m, new DateTime(2040, 1, 31));
        ...
        yield return new GiltInfo("TG46", "0 7/8% Treasury Gilt 2046", 0.88m, new DateTime(2046, 1, 31));
        ...
        yield return new GiltInfo("TG50", "0 5/8% Treasury Gilt 2050", 0.63m, new DateTime(2050, 10, 22));
        ...
        yield return new GiltInfo("T54", "4 3/8% Treasury Gilt 2054", 4.38m, new DateTime(2054, 7, 31));
        yield return new GiltInfo("TR54", "1 5/8% Treasury Gilt 2054", 1.63m, new DateTime(2054, 10, 22));
        ...
        yield return new GiltInfo("TG71", "1 5/8% Treasury Gilt 2071", 1.63m, new DateTime(2071, 10, 22));
        yield return new GiltInfo("TR73", "1 1/8% Treasury Gilt 2073", 1.13m, new DateTime(2073, 10, 22));
    }
}